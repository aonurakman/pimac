"""
PIMACV1 implementation for parallel multi-agent environments.
...
class PIMACV1(ParallelLearner):
    """
    Shared PIMACV1 implementation core backing the public parallel learner.
    ...
    def normalize_config(config: dict) -> dict:
        return normalize_config(config, PIMACV1_DEFAULT_CONFIG)
    ...
    def act(
        ...
        if agent_index is None:
            raise ValueError("PIMACV1.act requires agent_index. Prefer act_parallel for parallel environments.")
